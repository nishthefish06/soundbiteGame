// Client-side copy of server/src/game/songs.js's curated song pool, for the
// standalone prototype (which has no server connection). Keep in sync by
// hand until this mode gets real Room.js integration — at that point the
// server becomes the single source of truth and this file goes away.
